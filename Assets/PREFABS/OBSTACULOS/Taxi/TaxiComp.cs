...
public class TaxiComp : MonoBehaviour 
{
	...
	bool Medicion()
	{
		float dist1 = (GameManager.GetInstance().Player1.transform.position - PosIni).magnitude;
		float dist2 = (GameManager.GetInstance().Player2.transform.position - PosIni).magnitude;
